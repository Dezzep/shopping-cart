...
const Navbar = () => {
  return (
    <nav className="flex-col sm:flex sm:mb-8 p-1 sm:p-6 sticky top-0 bg-primary/95 text-primary-content z-50">
      
      <h1 className='text-3xl mb-4'>
        Stuff Store
      </h1>
      <ul className="flex ml-auto mr-6 gap-12 justify-evenly mb-2 sm:mb-0">
       <Link to='/'>
        ...
        <li className='tooltip tooltip-open tooltip-left tooltip-error ease-in duration-300 hover:tooltip-success cursor-pointer' id='shopping-bag' data-tip='1'>
